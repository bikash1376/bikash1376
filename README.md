...
<p align="center">
  <a href="https://bikash.useiota.space" target="_blank">portfolio</a> •
...
`React` `Node` `Express` `MongoDB` `Clerk` · [source](https://github.com/bikash1376/prepara)
...
- [gitnor](https://www.npmjs.com/package/gitnor) — CLI that generates `.gitignore` files from GitHub's official templates. `npx gitnor`
- [Sileo for Android](https://github.com/bikash1376/sileo-android) — Physics-based morphing notification island in Jetpack Compose
- [Blink-CC](https://github.com/iota-hq/blink-cc-windows) — Turns your Caps Lock LED into a status light for Claude Code
- [Screenshot](https://www.screenshot.useiota.space) — API service for capturing website screenshots from a URL
- [Interactive Map](https://interactive-map-eight-pi.vercel.app/) — Generates interactive learning maps from any topic
